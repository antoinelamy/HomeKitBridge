...
@class HAKInstanceIDPool, HAKService, HAKAccessoryInformationService, NSArray, NSHashTable, NSMutableArray, NSNumber, NSString;
...
@property(readonly, nonatomic) __weak HAKAccessoryInformationService *accessoryInformationService;
