...
@interface HAKCharacteristic : NSObject <NSCoding, NSCopying>
{
    ...
    HAKCharacteristicPermission _permissions;
    HAKCharacteristicFormat _format;
    HAKCharacteristicUnit _unit;
    HAKValueConstraints *_constraints;
    NSObject<OS_dispatch_queue> *_workQueue;
    NSHashTable *_subscribedConnectionsTable;
}

+ (id)stringForUnit:(HAKCharacteristicUnit)unit;
+ (id)stringForFormat:(HAKCharacteristicFormat)arg1;
...
- (id)initWithType:(HAKUUID *)type properties:(unsigned long long)arg2 format:(HAKCharacteristicFormat)format;
- (id)initWithType:(HAKUUID *)type;
